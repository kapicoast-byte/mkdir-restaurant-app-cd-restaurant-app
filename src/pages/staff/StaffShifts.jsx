// Staff Shifts — this week's shift schedule (content built in next phase)
  ...
  return (
    <div className={`min-h-full ${th.pageBg}`}>
      ...
      <div className="flex flex-col items-center justify-center px-6 py-24 text-center">
        ...
        <p className={`text-lg font-semibold ${th.text}`}>Shifts coming soon</p>
        <p className={`text-sm mt-1 ${th.textSub}`}>
          This week's schedule will appear here.
        </p>
      </div>
    </div>
  );
